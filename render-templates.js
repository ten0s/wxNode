...
var files = [
    ...
    { className: 'wxRealPoint', allowNew: true },
    ...
    //DKL  { className: 'wxWebView', allowNew: false, allowStaticNew: true },
    //DKL  { className: 'wxWebViewArchiveHandler', allowNew: true, noNewCopy: true },
    //DKL  { className: 'wxWebViewHandler', allowNew: false },
    //DKL  { className: 'wxWebViewHistoryItem', allowNew: true, noNewCopy: true },
    //DKL  { className: 'wxWebViewEvent', allowNew: true },
...
function methodJsonToCtx(parent, rawJson, methodJson) {
    ...
    if (methodJson['returns']) {
        ...
        //ctx.returnTypeConst = returnType['const'];
        //ctx.returnTypePointers = returnType['pointers'];
        ...
        if (ctx.returnTypeName == "void") {
            ...
            if (returnType.pointers === '*') {
                ...
                ctx.returnStmt = 'return scope.Close(v8::String::New((uint16_t*)returnVal, wcslen(returnVal)));';
            } else {
        ...
        if (ctx.id === "_45928") console.log(ctx, returnType);
    }
