...
//DKL #include "wxNode_wxWebView.h"
//DKL #include "wxNode_wxWebViewArchiveHandler.h"
//DKL #include "wxNode_wxWebViewHistoryItem.h"
...
//DKL    wxNode_wxWebView::Init(target);
//DKL    wxNode_wxWebViewArchiveHandler::Init(target);
//DKL    wxNode_wxWebViewHistoryItem::Init(target);
