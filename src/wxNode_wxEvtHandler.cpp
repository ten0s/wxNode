...
//DKL #include "wxNode_wxWebViewEvent.h"
...
//DKL  NODE_SET_PROTOTYPE_METHOD(func, "EVT_WEB_VIEW", _EVT_WEB_VIEW);
...
/*DKL
//static
v8::Handle<v8::Value> wxNode_wxEvtHandler::_EVT_WEB_VIEW(const v8::Arguments& args) {
wxNode_wxEvtHandler* evtHandler = unwrap<wxNode_wxEvtHandler>(args.This());
NodeExEvtHandlerImpl* self = unwrapEvtHandler(args.This());
