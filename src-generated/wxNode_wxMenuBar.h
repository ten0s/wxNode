...
public:
  ...
  wxNode_wxMenuBar(long unsigned int n, wxMenu** menus, const wxString* titles, long int style);
  wxNode_wxMenuBar(long unsigned int n, wxMenu** menus, const wxString* titles);
