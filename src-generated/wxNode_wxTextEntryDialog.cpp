...
v8::String::AsciiValue message(args[1]->ToString()); /* type: _13556  */
v8::String::AsciiValue caption(args[2]->ToString()); /* type: _13556  */
v8::String::AsciiValue value(args[3]->ToString()); /* type: _13556  */
long int style = (long int)args[4]->ToInt32()->Value(); /* type: _540  */
wxNode_wxPoint* pos = args[5]->IsNull() ? NULL : wxNodeObject::unwrap<wxNode_wxPoint>(args[5]->ToObject()); /* type: _18992  */
...
/*static*/ v8::Handle<v8::Value> wxNode_wxTextEntryDialog::_SetValue(const v8::Arguments& args) {
  ...
  if(args.Length() == 1 && args[0]->IsString()) {
    v8::String::AsciiValue val(args[0]->ToString()); /* type: _13556  */
...
/*static*/ v8::Handle<v8::Value> wxNode_wxTextEntryDialog::_SetTextValidator(const v8::Arguments& args) {
  ...
  if(args.Length() == 1 && (args[0]->IsNull() || (args[0]->IsObject() && wxNode_wxTextValidator::AssignableFrom(args[0]->ToObject()->GetConstructorName())))) {
    wxNode_wxTextValidator* validator = args[0]->IsNull() ? NULL : wxNodeObject::unwrap<wxNode_wxTextValidator>(args[0]->ToObject()); /* type: _61952  */
