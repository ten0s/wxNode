...
wxNode_wxValidator* validator = args[5]->IsNull() ? NULL : wxNodeObject::unwrap<wxNode_wxValidator>(args[5]->ToObject()); /* type: _57083  */
...
/*static*/ v8::Handle<v8::Value> wxNode_wxControl::_SetLabelMarkup(const v8::Arguments& args) {
   ...
   */
  if(args.Length() == 1 && args[0]->IsString()) {
    v8::String::AsciiValue markup(args[0]->ToString()); /* type: _13556  */
...
/*static*/ v8::Handle<v8::Value> wxNode_wxControl::_Ellipsize(const v8::Arguments& args) {
  ...
  if(args.Length() == 5 && args[0]->IsString() && (args[1]->IsNull() || (args[1]->IsObject() && wxNode_wxDC::AssignableFrom(args[1]->ToObject()->GetConstructorName()))) && args[2]->IsNumber() && args[3]->IsNumber() && args[4]->IsNumber()) {
    v8::String::AsciiValue label(args[0]->ToString()); /* type: _13556  */
wxNode_wxDC* dc = args[1]->IsNull() ? NULL : wxNodeObject::unwrap<wxNode_wxDC>(args[1]->ToObject()); /* type: _56935  */
wxEllipsizeMode mode = static_cast<wxEllipsizeMode>(args[2]->ToInt32()->Value()); /* type: _159  */
int maxWidth = (int)args[3]->ToInt32()->Value(); /* type: _142  */
int flags = (int)args[4]->ToInt32()->Value(); /* type: _142  */
...
/*static*/ v8::Handle<v8::Value> wxNode_wxControl::_FindAccelIndex(const v8::Arguments& args) {
  ...
  if(args.Length() == 2 && args[0]->IsString() && args[1]->IsString()) {
    v8::String::AsciiValue label(args[0]->ToString()); /* type: _13556  */
wxString* labelOnly; /* type: _22494 * */
